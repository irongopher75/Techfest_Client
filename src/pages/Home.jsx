            ...
            <section style={{
                ...
                <div className="animate-fade-in" style={{ zIndex: 2, width: '100%' }}>
                    <div style={{
                        ...
                        <img src="/assets/nmims-shirpur-logo.png" alt="NMIMS Logo" style={{ height: window.innerWidth < 768 ? '40px' : '60px', filter: 'brightness(0) invert(1)' }} />
                        <div style={{ width: '2px', height: window.innerWidth < 768 ? '30px' : '50px', background: 'var(--glass-border)' }}></div>
                        <img src="/assets/ambiora-logo.png" alt="Ambiora Logo" style={{ height: window.innerWidth < 768 ? '40px' : '60px' }} />
                    </div>
