                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '80px', marginBottom: '80px' }}>
                    <div>
                        <Link to="/" style={{ textDecoration: 'none', color: 'inherit' }}>
                            <h2 className="tech-font" style={{ fontSize: '2rem', fontWeight: '800', letterSpacing: '2px', marginBottom: '25px', filter: 'drop-shadow(0 0 10px var(--primary-glow))' }}>
                    ...
                    <div>
                        <h4 className="tech-font" style={{ marginBottom: '30px', fontSize: '0.9rem', color: '#fff', letterSpacing: '2px' }}>SYSTEM_NAVIGATION</h4>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                            ...
                            <Link to="/signup" style={{ color: 'var(--text-muted)', textDecoration: 'none', transition: '0.3s', fontSize: '0.9rem' }} onMouseOver={e => e.target.style.color = 'var(--primary)'} onMouseOut={e => e.target.style.color = 'var(--text-muted)'}>Registration</Link>
                            <Link to="/login" style={{ color: 'var(--text-muted)', textDecoration: 'none', transition: '0.3s', fontSize: '0.9rem' }} onMouseOver={e => e.target.style.color = 'var(--primary)'} onMouseOut={e => e.target.style.color = 'var(--text-muted)'}>User Console</Link>
                        </div>
                    </div>
                    <div>
                        <h4 className="tech-font" style={{ marginBottom: '30px', fontSize: '0.9rem', color: '#fff', letterSpacing: '2px' }}>LOCATION_DATA</h4>
